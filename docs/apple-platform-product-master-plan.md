...
状態: **Layout repair implemented／assistive matrix pending**
...
- 共有検索ソースの iOS Simulator build、macOS 全 `TripMapTests`、上記 Venue 検索 UI tests は
  Xcode 27 beta で成功した。
- 2026-07-27 に QA 専用の決定的な Dark Appearance 入口と、複数ディスプレイ環境でも対象
...
- iOS 27 の Debug-QA を iPhone 17 Pro と iPad Pro 11-inch Simulator で起動し、Guide の
